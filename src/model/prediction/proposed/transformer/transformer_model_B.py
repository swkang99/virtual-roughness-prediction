...
class ModalityAwareTokenEmbed(nn.Module):  # Total trainable parameters = 131,108
    """
    ...
    Since subpatch_size is removed:
        each pixel is one token

    Therefore each raw token has:
